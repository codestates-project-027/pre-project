...
const LeftSidebar = () => {
  ...
  const HomeCheckUrl = () => {
     setHomeActive(!homeActive); setQActive(false); setHomeActive(true);
  }

  const QCheckUrl= () => {
     setQActive(!qActive); setHomeActive(false); setQActive(true);
  }
  ...
  return (
    <LeftSideCss>
        ...
        <Link to="/">
             ...
             onClick={HomeCheckUrl}
             className={homeActive? 'active' : null}
             >
              Home
               </Menu></Link>
             ...
             <Link to="/questionspage"> <Submenu 
             onClick={QCheckUrl}
             className={qActive? 'active':null}
             >
              <IoEarthSharp/>
              &nbsp;Questions
               </Submenu></Link>
